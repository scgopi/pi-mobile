...
mavenPublishing {
    ...
    signAllPublications()
    coordinates("io.github.scgopi", "pi-agent-core", "1.0.1")

    pom {
        name.set("PiAgentCore")
        description.set("Agent loop and tool system for LLM-powered assistants")
